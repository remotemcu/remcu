...
REMCULIB_DLL_API bool remote_memcpy(const uintptr_t addr, const char* sink, const size_t size);

REMCULIB_DLL_API bool local_memcpy(const uintptr_t addr, const size_t size, char* dist);
